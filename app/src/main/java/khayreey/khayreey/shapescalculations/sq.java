...
import static khayreey.khayreey.shapescalculations.R.drawable.second;
...
public void result()
{
   result_btn.setOnClickListener(new View.OnClickListener() {
       ...
       if(currentX.length()==0)
       {
           ...
           Toast toast =Toast.makeText(sq.this,"please enter x",Toast.LENGTH_LONG);
           toast.show();
           ...
           if (area_btn.isChecked()) {
               ...
               double y = Double.parseDouble(currentX);
               result = 4 * y;
               result_txt.setText(String.valueOf(result));
               op_btn.setEnabled(true);
               area_btn.setEnabled(true);
               ...
               Toast toast = Toast.makeText(sq.this, "choose one first", Toast.LENGTH_LONG);
               toast.show();
